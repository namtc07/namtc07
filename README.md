...
const namtc07 = {
  tên:        "Nam TC",
  vai_trò:    "Frontend Developer",
  vị_trí:    "🇻🇳 Việt Nam",
  đam_mê:    ["Web Dev", "UI/UX", "Open Source"],
  hiện_tại:  "Xây dựng sản phẩm web đẳng cấp",
  học_hỏi:   ["React 19", "TypeScript", "Next.js App Router"],
  hỏi_tôi:   ["HTML", "CSS", "JavaScript", "React"],
  fun_fact:  "Tôi debug tốt hơn sau 3 tách cà phê ☕",
};
```

- 🔭 Đang làm việc với các dự án **Frontend thực tế**
- 🌱 Đang học **React 19, TypeScript & Next.js App Router**
...
<details>
<summary>💡 <b>Câu trích dẫn yêu thích của tôi</b></summary>
<br/>
<blockquote>
<i>"Code không chỉ là công việc — đó là nghệ thuật. Mỗi dòng lệnh là một nét cọ trên bức tranh kỹ thuật số."</i>
<br/>— namtc07
</blockquote>
</details>
