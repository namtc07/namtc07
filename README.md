...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:0d1117&height=180&section=header&text=namtc07&fontSize=72&fontColor=58a6ff&animation=twinkling&fontAlignY=40&desc=Frontend%20Developer%20%7C%20React%20%7C%20TypeScript%20%7C%20Next.js&descSize=16&descAlignY=62&descColor=8b949e" width="100%"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=20&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=700&lines=%24+whoami+→+Nam+TC+%7C+Frontend+Developer;%24+echo+%22Turning+ideas+into+pixels%22;%24+git+commit+-m+%22make+it+work%2C+make+it+right%2C+make+it+fast%22;%24+npm+run+build+→+%E2%9C%94+compiled+successfully)](https://git.io/typing-svg)

<p>
  <img src="https://komarev.com/ghpvc/?username=namtc07&color=58a6ff&style=flat-square&label=profile+views" alt="profile views"/>
  <img src="https://img.shields.io/github/followers/namtc07?style=flat-square&color=58a6ff&labelColor=161b22&label=followers" alt="followers"/>
</p>
...
const dev = {
  ...
  location:   "🇻🇳 Việt Nam",
  focus:      ["Web Performance", "UI/UX", "DX"],
  currently:  "Building production-grade web apps",
  learning:   ["React 19", "TypeScript", "Next.js App Router"],
  ask_me:     ["HTML", "CSS", "JavaScript", "React"],
  fun_fact:   "I debug better after 3 cups of ☕",
  available:  true,
} satisfies Developer;
```
...
- 📫 Reach me at **namtc07.wrk@gmail.com**
